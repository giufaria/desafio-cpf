...
import { CandidatoGuard } from '../shared/guards/candidato.guard';
import { PainelDoCandidatoComponent } from '../candidate/components/painel-do-candidato/painel-do-candidato.component';
import { TechnicalTestComponent } from '../candidate/components/tests/technical-test/technical-test.component';
import { LogicTestComponent } from '../candidate/components/tests/logic-test/logic-test.component';
import { IntroductionToInformaticsComponent } from '../candidate/components/crash-courses/introduction-to-informatics/introduction-to-informatics.component';
import { FollowUpComponent } from '../candidate/components/follow-up/follow-up.component';
    ...
    children: [
      {
        ...
        component: PainelDoCandidatoComponent,
      },
      {
        path: "enviar-video-analista-midia-digital-performance/:id",
        component: EnviarVideoComponent,
      },
      {
        path: "enviar-video-engenharia-de-dados/:id",
        component: EnviarVideoComponent,
      },
      {
        path: "enviar-video-java-full-stack/:id",
        component: EnviarVideoComponent,
      },
      {
        path: "enviar-video-desenvolvedor-salesforce/:id",
        component: EnviarVideoComponent,
      },
      {
        path: "teste-tecnico/:id",
        component: TechnicalTestComponent,
      },
      {
        path: "teste-de-logica/:id",
        component: LogicTestComponent,
      },
      { path: "minicurso/:id", 
        component: IntroductionToInformaticsComponent 
      },
      {
        path: "follow-up/:id",
